...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "GridcoinNetwork") type = GridcoinNetwork;
    if(strType == "GridcoinNetworkVariable") type = GridcoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == GridcoinNetwork) s = "GridcoinNetwork";
    if(type == GridcoinNetworkVariable) s = "GridcoinNetworkVariable";
