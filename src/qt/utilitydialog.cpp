    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Gridcoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Gridcoin Core"));
...
All the Gridcoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 GRIDCOIN, 0.1 GRIDCOIN, 1 GRIDCOIN and 10 GRIDCOIN -- sort of like the paper money you use every day.</li> \
...
For more info see <a href=\"https://gridcoin.atlassian.net/wiki/display/DOC/PrivateSend\">https://gridcoin.atlassian.net/wiki/display/DOC/PrivateSend</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Gridcoin Core is shutting down...") + "<br /><br />" +
