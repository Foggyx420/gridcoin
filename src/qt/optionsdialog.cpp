    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("GRIDCOIN-light"), QVariant("light"));
    ui->theme->addItem(QString("GRIDCOIN-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("GRIDCOIN-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("GRIDCOIN-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("GRIDCOIN-traditional"), QVariant("trad"));
