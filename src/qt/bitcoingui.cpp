    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("Gridcoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and gridcoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About Gridcoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Gridcoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Gridcoin Core"));
    ...
    openAction->setStatusTip(tr("Open a gridcoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Gridcoin Core help message to get a list with possible Gridcoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Gridcoin Core client") + " " + networkStyle->getTitleAddText();
...
{
    QString strTitle = tr("Gridcoin Core"); // default title
