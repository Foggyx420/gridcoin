// Copyright (c) 2014-2017 The Gridcoin Core developers and the Gridcoin Core developers
...
void CActiveMasternode::ManageStateInitial(CConnman& connman)
{
    ...
    if(pwalletMain->GetBalance() < 1000*COIN) {
        LogPrintf("CActiveMasternode::ManageStateInitial -- %s: Wallet balance is < 1000 GRIDCOIN\n", GetStateString());
        return;
    }
