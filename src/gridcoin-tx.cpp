...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("Gridcoin Core gridcoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  gridcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded gridcoin transaction") + "\n" +
              "  gridcoin-tx [options] -create [commands]   " + _("Create hex-encoded gridcoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded gridcoin transaction
