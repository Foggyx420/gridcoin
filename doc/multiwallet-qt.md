...
Only requiring some minor changes is gridcoin.cpp.
...
Changes to gridcoin.cpp
----------------------
gridcoin.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
