...
This mechanism has been integrated into Bitcore-Node-Gridcoin which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/gridcoin/insight-api-gridcoin#web-socket-api](https://github.com/gridcoin/insight-api-gridcoin#web-socket-api)
* API: [https://github.com/gridcoin/insight-api-gridcoin#instantsend-transactions](https://github.com/gridcoin/insight-api-gridcoin#instantsend-transactions)
...
By default, the Gridcoin Core daemon will launch using the following constant:

```
static const int DEFAULT_INSTANTSEND_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Gridcoin Core daemon:
